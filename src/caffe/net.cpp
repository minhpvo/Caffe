...
void Net<Dtype>::AppendParam(const NetParameter& param, const int layer_id,                             const int param_id) {
    ...
    } else
    {
        ...
        //cout<<"Current para list"<<endl;
        //for(int ii=0; ii<param_names_index_.size(); ii++)
        //   cout<<param_names_index_[ii]<<endl;
        //for (auto& x: param_names_index_) {
        ...
        /*if(param_name == "76")
        {
            cout<<"XXX: "<< param_spec->lr_mult()<<endl;
            cout<<"XXX: "<<  params_lr_[learnable_param_id]<<endl;
        }*/
